    ...
    <header className="relative z-10 text-center py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-center mb-4">
          {/* icon bubble */}
          <div className="p-3 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-2xl mr-4">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          <button
            ...
            className={`group relative px-8 py-3 rounded-2xl font-semibold transition-all duration-300 ${startBtnClass}`}
          >
          ...
          <button
            onClick={onClearData}
            className="px-8 py-3 rounded-2xl font-semibold bg-red-600/20 border border-red-500/30 text-red-400 hover:bg-red-600/30 hover:text-red-300 transition-all duration-300 hover:scale-105"
          >
            Clear Data
          </button>
        </div>
